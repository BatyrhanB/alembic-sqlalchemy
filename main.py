...
from src.users import models, schemas, crud
...
def create_book_for_user(
    ...
    return crud.create_user_books(db=db, book=book, user_id=user_id)
...
#advanced dependency middleware for db
# @app.middleware("http")
